...
<html lang="en">
  <head>
    ...
    <script src="../User/initMap.js"></script>
...
<nav class="navbar">
    ...
    <ul class="nav-links">
      ...
      <!-- NAVIGATION MENUS -->
      <div class="menu">
        <li><a href="../logout.php"><center><img src="../User/Images/LogoutIcon.png" alt="Logout" style="width:30%">Logout</center></a></li>
      </div>
    </ul>
  </nav>
  <body style="padding: 0;">
  <section style="margin-top: 45px; margin-bottom: 50px;" class="container1">
    <h2 style="color: black;">Welcome Guest</h2>
    <?php
     ...
     <div class="schedule">
        ...
        <table>
            ...
            <button class="submitButton">
                <a href="../User/Images/Shuttle-Map.pdf" style=" color: white !important;">View Shuttle Map</a>
            </button>
             <button class="submitButton">
                <a href="../User/Images/CampusMap.png" style=" color: white !important;">View Campus Map</a>
            </button>
